...
- 🔍 **Document Search**: Uses Claude Agent SDK with file tools (Read, Write, Grep, Glob) to search through documents
- 📊 **Automated Evaluation**: Evaluates answers on accuracy and completeness using OpenAI's structured output
- 📈 **Batch Processing**: Process multiple questions from JSON files
- 💰 **Cost Tracking**: Monitor Claude API usage and costs
- 📋 **Detailed Reports**: Generate comprehensive evaluation reports with individual and aggregate scores
...
claude-sdk-search/
├── data/                          # Data files
│   ├── 2507.13334v2.md          # Source document (research paper)
│   ├── questions_answers.json    # Input questions and expected answers
│   └── questions_answers_short.json # Shorter version for testing
├── file_query.py                 # Main script for question answering
